...
class TestDeepSeekPerformanceAndRateLimiting:
    ...
    def test_individual_response_performance(self):
        ...
        for prompt in prompts:
            ...
            assert (
                result["response_time_ms"] < self.PERFORMANCE_THRESHOLDS["max_response_time_ms"]
        ...
        assert (
            avg_response_time < self.PERFORMANCE_THRESHOLDS["avg_response_time_ms"]
    ...
    def test_concurrent_request_performance(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(
            max_workers=self.PERFORMANCE_THRESHOLDS["concurrent_requests"]
        ) as executor:
    ...
    def test_rate_limiting_behavior(self):
        ...
        if response_times:
            ...
            assert (
                max_rate_limited_time < self.PERFORMANCE_THRESHOLDS["max_response_time_ms"] * 1.5
    ...
    def test_token_generation_rate(self):
        ...
        assert (
            tokens_per_second <= self.PERFORMANCE_THRESHOLDS["max_tokens_per_second"]
